...
public class DogKennel {
	public static void main(String[] args) {
		//TODO:
		// lav en ny hund
		Dog myDog = new Dog("woodie", true, 1);
		// sæt en ejer
		...
		for (String myD: myOff) {
			if (myD != null) System.out.println(myD);
		}
		ArrayList<String> extraDogs = myDog.getOffSpringExtra();
		for (String myExtraD: extraDogs) {
			System.out.println("Extra dog: " + myExtraD);
		}

		//Raw arrays
		System.out.println(Arrays.toString(myOff));
		System.out.println(myDog.getOffSpringExtra());
